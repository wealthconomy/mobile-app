        ...
        >
          <View className="gap-y-[10px]">
            <MenuItem
              ...
              onPress={() => router.push("/security/add-bvn")}
            />
            <MenuItem
              title="Add NIN"
              icon={<Ionicons name="finger-print" size={24} color="#155D5F" />}
              onPress={() => router.push("/security/add-nin")}
            />
            <MenuItem
              ...
              onPress={() => router.push("/security/verify-address")}
            />
            <MenuItem
            ...
            <MenuItem
              ...
              onPress={() => router.push("/security/enable-face-id")}
            />
            <MenuItem
